...
public class Database<K, V> {
	...
	public class ReadIterator implements AutoCloseable {
		...
		/**
		 * Returns key of a record currently pointed by the iterator. It is just an
		 * accessor - key cannot be updated in Database using this method.
		 *
		...
		/**
		 * Returns value of a record currently pointed by the iterator. It is just an
		 * accessor - data cannot be written to Database using this method.
		 *
		 * If the iterator is on an undefined position, calling this method is undefined
		 * behaviour.
		 *
