...
public class Database<K, V> {
	...
	/**
	 * Binding for an pmemkv iterator API. Iterator provides methods to iterate over
	 * records in db. Object can be created only using Database method.
	 * <p>
	 * Important: This is an experimental feature and should be not used in
