...
public class Database<K, V> {
	 ...
	 * Exception thrown by user from callback will be propagated.
	 *
	 * @param callback
	 ...
	 * equivalent to std::string::compare in C++. Any Exception thrown by user from
	 ...
	 * datastore. Any Exception thrown by user from callback will be propagated.
	 *
	 * @param callback
	 ...
	 * by user from callback will be propagated.
	 *
	 * @param key
	 *            key to query for.
	 * @param callback
