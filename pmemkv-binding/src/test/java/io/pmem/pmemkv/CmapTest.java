...
public class CmapTest {
	...
	/* Test using multiple instances of the same DB */
	@Test
	...
	public void multipleDBTypesTest() {
		...
		Database<String, String> dbString = createDB(ENGINE, file1, new StringConverter(), 300, 300);
		...
		Database<ByteBuffer, ByteBuffer> dbByteBuffer = createDB(ENGINE, file2, new ByteBufferConverter(), 200, 200);
		for (int i = 0; i < numberOfElements; ++i) {
