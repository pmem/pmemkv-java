...
public class Database<K, V> {
	 ...
	 *
	 * @return true if engine is stoped, false if it is running.
	 * @since 1.0
	 */
	...
	/**
	 * Executes callback func with value of a given key
	 *
	 * @param key
	 *            key to query for.
	 * @param callback
	 ...
	 * @param key
	 *            key to query for.
	 * @return Copy of value associated with the given key or null if not foud
	 */
	...
	public static class Builder<K, V> {
		 ...
		 * of arbitrary choosen type K as key by providing object, which implements
		 ...
		 *
		 * All data is internally stored as ByteBuffer. It's possible to store objects
		 * of arbitrary choosen type V as value by providing object, which implements
