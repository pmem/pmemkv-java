...
public class Database<K, V> {
    ...
    /**
     * Executes callback function for every key stored in the pmemkv datastore, whose keys are greater than the given
     * key.
     * 
     * @param key
    ...
    /**
     * Executes callback function for every key stored in the pmemkv datastore, whose keys are greater than the key1 and
     * less than the key2.
     * 
     * @param key1
     *            Sets the lower bound for querying.
    ...
    /**
     * Returns number of currently stored key/value pairs in the pmemkv datastore, whose keys are greater than the given
     * key.
     * 
     * @param key
     *            Sets the lower bound for querying.
    ...
    /**
     * Returns number of currently stored key/value pairs in the pmemkv datastore, whose keys are less than the given
     * key.
     * 
     * @param key
     *            Sets the upper bound for querying.
    ...
    /**
     * Returns number of currently stored key/value pairs in the pmemkv datastore, whose keys are greater than the key1
     * and less than the key2.
     * 
     * @param key1
     *            Sets the lower bound for querying.
     * @param key2
    ...
    /**
     * Executes callback function for every key/value pair stored in the pmemkv datastore, whose keys are greater than
     * the given key.
     * 
     * @param key
     *            Sets the lower bound for querying.
    ...
    /**
     * Executes callback function for every key/value pair stored in the pmemkv datastore, whose keys are lower than the
     * given key.
     * 
     * @param key
     *            Sets the upper bound for querying.
    ...
    /**
     * Executes callback function for every key/value pair stored in the pmemkv datastore, whose keys are greater than
     * the key1 and less than the key2.
     * 
     * @param key1
     *            Sets the lower bound for querying.
     * @param key2
     ...
     * @param key
     *            to query for.
     * @return true if key exists in datastore, false otherwise
     */
    ...
    /**
     * Builder is used to build instances of pmemkv Database class from values configured by the setters.
     */
    public static class Builder<K, V> {
        ...
        /**
         * Sets converter object from given key type K to ByteBuffer.
         *
         * All data is internally stored as ByteBuffer. It's possible to store objects of arbitrary choosen type K as
         * key by providing object, which implements conversion between K and ByteBuffer. Such object have to implement
         * Converter interface
         *
        ...
        /**
         * Sets converter object from given value type V to ByteBuffer.
         *
         * All data is internally stored as ByteBuffer. It's possible to store objects of arbitrary choosen type V as
         * value by providing object, which implements conversion between K and ByteBuffer. Such object have to
         * implement Converter interface.
         *
         * @param newValueConverter
         *            Converter object object from V type to ByteBuffer
         * 
         * @return this builder
         */
