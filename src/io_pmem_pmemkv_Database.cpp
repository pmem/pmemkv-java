...
private:
    std::unordered_map<int, const char*> PmemkvStatusDispatcher = {
       { PMEMKV_STATUS_UNKNOWN_ERROR, "io/pmem/pmemkv/exceptions/UnknownErrorException" },
       { PMEMKV_STATUS_NOT_FOUND, "io/pmem/pmemkv/exceptions/NotFoundException"},
       { PMEMKV_STATUS_NOT_SUPPORTED, "io/pmem/pmemkv/exceptions/NotSupportedException"},
       { PMEMKV_STATUS_INVALID_ARGUMENT, "io/pmem/pmemkv/exceptions/InvalidArgumentException"},
       { PMEMKV_STATUS_CONFIG_PARSING_ERROR, "io/pmem/pmemkv/exceptions/ConfigParsingErrorException"},
       { PMEMKV_STATUS_CONFIG_TYPE_ERROR, "io/pmem/pmemkv/exceptions/ConfigTypeErrorException"},
       { PMEMKV_STATUS_STOPPED_BY_CB, "io/pmem/pmemkv/exceptions/StoppedByCallbackException"},
       { PMEMKV_STATUS_OUT_OF_MEMORY, "io/pmem/pmemkv/exceptions/OutOfMemoryException"},
       { PMEMKV_STATUS_WRONG_ENGINE_NAME, "io/pmem/pmemkv/exceptions/WrongEngineNameException"},
       { PMEMKV_STATUS_TRANSACTION_SCOPE_ERROR, "io/pmem/pmemkv/exceptions/TransactionScopeErrorException"},
    };

    JNIEnv* env;

public:
    const char* DatabaseException = "io/pmem/pmemkv/exceptions/DatabaseException";
    const char* GeneralException = "java/lang/Error";
...
void callback_get_byte_array(const char* v, size_t vb, void *arg)  {
    ...
    if(c->result = c->env->NewByteArray(vb)){
        ...
        ex.ThrowException(ex.DatabaseException, "Cannot allocate output buffer");
    }
};
